...
def print_usage():
    print '\033[93m'
    print 'run.py [--help] [--dimension {3,6,9}] [--save e] [--train dir] [--result dir] [--epochs e] [--restore checkpointfile]'
...
def autoencoder(x):
	...
	prevLayer = conv2 = conv2d(prevLayer, 44, 'conv2')
	...
	prevLayer = conv4 = conv2d(prevLayer, 76, 'conv4')
	prevLayer = pool4 = maxpool2d(prevLayer, 2, 'pool4') # 32 -> 16

	prevLayer = conv5 = conv2d(prevLayer,  100, 'conv5')
	...
	prevLayer = conv8 = conv2d(prevLayer, 84, 'conv8')
	prevLayer = conv8b = conv2d(prevLayer, 84, 'conv8b')
